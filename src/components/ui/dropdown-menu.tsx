  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-40 overflow-hidden rounded-xl border border-white/55 bg-popover p-1 text-popover-foreground shadow-xl backdrop-blur-xl dark:border-white/10",
          className,
        )}
        {...props}
      />
