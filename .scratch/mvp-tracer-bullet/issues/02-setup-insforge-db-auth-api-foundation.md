...
- To complete the final two end-to-end checks, create real InsForge auth users, map them into `public.app_users` using `docs/insforge-foundation.md`, sign in, then verify the read/write foundation endpoints.
...
- [ ] A signed-in user can be resolved to Landlord or Staff.
